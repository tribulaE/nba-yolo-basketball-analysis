...
class PassInterceptionDrawer:
    ...
    def draw_frame(self, frame, frame_num, passes, interceptions):
        ...
        pass_till_frame = passes[:frame_num + 1]
        interceptions_till_fame = interceptions[:frame_num + 1]

        team_1_passes,  team_2_passes,  team_1_interceptions,  team_2_interceptions = self.get_stats(pass_till_frame, interceptions_till_fame)
